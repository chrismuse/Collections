...
public class TeamWrapper {
    ...
    */
    ...
    /**
     * Checks if there is space left on the main team. The main team can only
     * have 10 fighters.
    ...
    public void addToTeam(Character c) {
        if (checkTeamCapacity()) {
            if (!(team.contains(c)) && !(reserve.contains(c))) {
                team.add(c);
            }
        }
    }
    ...
    /**
     * Removes c from the main team and adds c to the reserve if there is
     * space on the reserve. C must be succesfully removed from the main team
     * before adding to the reserve.
     * @param c - a character to move
    ...
    /**
     * Removes c from the reserve and adds c to the main team if there is
     * space on the main team. C must be successfully removed from the reserve
     * before adding to the main team.
     * @param c - a character to move
     * @return If c was successfully moved to the main team, return true,
